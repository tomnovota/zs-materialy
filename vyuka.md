...
2. řeší některé aktivity, které by lidi nikdy ručně nezvládli
	- předpověď počasí
...
- postup, kterým získáme řešení problému se nazývá algoritmus (funkce v matematice)
	...
	- postup, jak pro konkrétní vstup získat požadovaný výstup
		- máme omezené instrukce/operace, které můžeme použít

- příklady nějakých symbolických algoritmů
...
- programovací jazyk jsou instrukce, které jsou blíže lidské řeči než instrukce počítače
- napsaný program se poté přeloží do instrukcí ("řeči") počítače
- pevně daná pravidla, která musí být přesně dodržována, jinak program nebude fungovat
- typické objekty v programovacím jazyce
	- proměnné
		- datové typy:
			- bool
			- int
	...
	- podmínky (if-else)
	- cykly (for, while)
		- když se nějaká operace má provést několikrát po sobě
	- funkce (podprogram)
		- nahrazení opakujících se vzorů/částí kódu
		- logické členění kódu

- vývoj programu
	- návrh řešení (na papír)
